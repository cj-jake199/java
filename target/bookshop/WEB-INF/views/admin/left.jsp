...
<ul class="menu">
	<c:choose>
		...
		<c:when test="${sessionScope.user.name eq 'admin'}" >
			<li><a href="<%=request.getContextPath()%>/admin/authorityList">管理员权限管理</a></li>
			<li><a href="<%=request.getContextPath()%>/user/member">会员管理</a></li>
			<li><a href="<%=request.getContextPath()%>/user/listByPage">数据报表</a></li>
		</c:when>
